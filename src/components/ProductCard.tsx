        ...
        <li key={product.name} className="m-4">
            <div className="rounded-2xl border-2 shadow-2xl bg-white hover:ring-4 hover:ring-indigo-500 hover:ring-offset-4 hover:ring-offset-gray-50 focus:ring-4 " onClick={handleOpenModal}>
                ...
                <div className='flex justify-between'>
                    <h3 className="whitespace-nowrap sm:text-sm md:text-base lg:text-lg font-semibold text-gray-600 px-6 pb-4">
                        {product.name}
                    </h3>
                    <h3 className="whitespace-nowrap sm:text-sm md:text-base lg:text-lg  text-base font-semibold text-gray-600 px-6 pb-4">
